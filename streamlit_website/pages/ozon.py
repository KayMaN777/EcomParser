...
st.set_page_config(page_title="Ozon Аналитика", layout="wide")
primary_color = "#0749ff"
...
st.markdown(
    f"<h1 style='text-align:center; color:{primary_color}'>Ozon Аналитика</h1>",
    unsafe_allow_html=True
)
...
endpoints = {
    "Поиск": "api/v1/ozon/search",
    "Категория": "api/v1/ozon/category",
    "Продавец": "api/v1/ozon/seller"
}
