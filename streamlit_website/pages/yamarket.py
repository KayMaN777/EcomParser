...
st.set_page_config(page_title="Yandex Market Аналитика", layout="wide")
...
st.markdown(
    f"<h1 style='text-align:center; color:{primary_color}'>Yandex Market Аналитика</h1>",
    unsafe_allow_html=True
)
...
endpoints = {
    "Поиск": "api/v1/yamarket/search",
    "Категория": "api/v1/yamarket/category",
    "Продавец": "api/v1/yamarket/seller"
}
...
if submit:
    ...
    if error:
        ...
        st.success(f"✅ Получен файл: с результатами запроса. Всего позиций: {len(df)}")
