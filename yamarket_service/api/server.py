...
from api.proto.yamarket_service_pb2_grpc import YamarketServiceServicer
from api.proto.yamarket_service_pb2 import (
    ListProductResponse
)

class YamarketService(YamarketServiceServicer):
